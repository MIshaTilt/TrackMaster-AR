...
public static class MeshUtils {
    ...
    public static Mesh CreateLineMesh(Vector3 pointA, Vector3 pointB, Vector3 normal, float width) {
        ...
        Vector3 vertexALeft = pointA + Vector3.left * widthHalf;
        Vector3 vertexARight = pointA + Vector3.right * widthHalf;
        
        Vector3 vertexBLeft = pointB + Vector3.left * widthHalf;
        Vector3 vertexBRight = pointB + Vector3.right * widthHalf;
